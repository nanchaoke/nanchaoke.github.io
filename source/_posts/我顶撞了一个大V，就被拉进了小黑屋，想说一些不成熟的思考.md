...
<div>
	<ul style="margin: 0;">
		<li style="list-style: none; background: #eef3fc; border-radius: 10px; overflow: hidden; padding: 1rem; margin-bottom: 1rem; cursor: pointer; position: relative; min-height: 90px;">
            ...
            <img style="max-width: 24%; height: 70px; border-radius: 10px; float: right; margin-top: .2rem;" src="https://write.godread.cn/molisenshidaoqian/tupochuangkou.jpg"/>
		</li>
        <li style="list-style: none; background: #eef3fc; border-radius: 10px; overflow: hidden; padding: 1rem; margin-bottom: 1rem; cursor: pointer; position: relative; min-height: 90px;">
        ...
        <li style="list-style: none; background: #eef3fc; border-radius: 10px; overflow: hidden; padding: 1rem; margin-bottom: 1rem; cursor: pointer; position: relative; min-height: 90px;">
			...
			<img style="max-width: 24%; height: 70px; border-radius: 10px; float: right; margin-top: .2rem;" src="http://write.godread.cn/chuanpudashi/fanlandongbuzhou.jpg"/> 
		</li>
	</ul>
</div>
